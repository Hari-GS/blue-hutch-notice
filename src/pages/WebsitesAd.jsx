...
function WebsitesAd() {
    return (
        <div className='text-white md:px-5 px-4 md:py-14 py-32'>
        <div className='flex md:flex-row flex-col justify-between'>
            
            <div className='md:w-1/2 md:px-10'>
                <div className="text-lg">Custom Websites / Web Applications</div>
                <div className="bg-[#DBFF5E] h-0.5 md:w-[295px]"></div>
            ...
            <div>
                ...
                <p className="text-[24px] text-[#DBFF5E] mt-8 md:pr-48 text-center">Hari & Deepan<br/><h5 className="text-white">The Developer Duo You'll Ever Need</h5><br/><p className="md:text-[17px] text-base">For Orders : <br/> 6369312803 - WhatsApp preferred<br/>Email : bluehutch01@gmail.com</p></p>    
            </div>
