...
const About = () => {
  return (
    <div className="md:h-[140vh] md:pt-11 py-10 text-[#493628]">
      
      <p className="text-center items-center md:text-[18px] py-2 text-[#493628] flex flex-col">
        <div>
          Featured
        </div>
        <div className="bg-[#493628] w-[300px] md:h-0.5 md:w-[90px] "></div>
      </p>

      <div className="md:h-[300px]  md:flex justify-center items-center gap-10">
      <Link to="/websites" className="cursor-pointer h-[250px] md:w-[280px] mx-4 rounded-[20px] mt-12 bg-[#493628] hover:bg-[#AB886D] flex items-center flex-col justify-center transform transition-transform duration-300 hover:-translate-y-3">
          <FontAwesomeIcon icon={faLaptopCode} className="text-[100px] text-[#E4E0E1]" />
        ...
        {/* Mentoring Box */}
        <div className="h-[250px] md:w-[280px] mx-4 rounded-[20px] md:mt-0 mt-5 bg-[#493628] flex items-center flex-col justify-center transform transition-transform duration-300 hover:-translate-y-3">
        ...
        <div className="h-[250px] md:w-[280px] mx-4 rounded-[20px] md:mt-0 mt-5 bg-[#493628] flex items-center flex-col justify-center transform transition-transform duration-300 hover:-translate-y-3">
          <FontAwesomeIcon icon={faLayerGroup} className="text-[100px] text-[#E4E0E1]"/>
          <h5 className="max-w-[300px] mx-auto text-[18px] text-center pt-2 text-[#E4E0E1]">
      ...
      <div className="md:flex items-center pt-12 md:pt-50 md:px-24">
        ...
        <div className="flex-1 md:pt-0 pt-5 px-4">
          ...
          <div className="bg-[#493628] h-1 w-[100px] md:w-[130px]  mb-4"></div>
        ...
        <div className="flex-shrink-0 text-center md:pt-0 py-3 md:text-right md:w-2/6">
          <p className="text-[24px] text-[#493628]">Hari & Deepan<br/><h5 className="text-[#493628]">The Developer Duo You'll Ever Need</h5></p>
